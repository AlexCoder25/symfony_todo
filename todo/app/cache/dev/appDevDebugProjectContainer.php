...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TodoBundle', ($this->targetDirs[2].'/Resources/TodoBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TodoBundle', ($this->targetDirs[3].'/src/TodoApp/TodoBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['assetic.filter.sass'] = $instance = new \Assetic\Filter\Sass\SassFilter('/Users/Apple/.rvm/gems/ruby-1.9.3-p547/bin/sass', '/usr/bin/ruby');
    ...
    {
        $this->services['assetic.filter.scss'] = $instance = new \Assetic\Filter\Sass\ScssFilter('/Users/Apple/.rvm/gems/ruby-1.9.3-p547/bin/sass', '/usr/bin/ruby');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'scss' => 'assetic.filter.scss', 'sass' => 'assetic.filter.sass'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'todo', 'user' => 'root', 'password' => 'qwe', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/TodoApp/TodoBundle/Entity'))), 'TodoApp\\TodoBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('TodoBundle' => 'TodoApp\\TodoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3218e10f4a7b132a1bd680740ef8eab90f2375f09ddc2f3c2ed72f0e4f177d29');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'TodoBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/TodoApp/TodoBundle/Resources/views'), 'Todo');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dd74acf78cc155ae26a51e766fd7beb62c381e4a');
    }
    ...
    protected function getAssetic_AssetFactoryService()
    {
        ...
        $instance->addWorker(new \Assetic\Factory\Worker\EnsureFilterWorker('/\\.scss$/', $this->get('assetic.filter.scss')));
        $instance->addWorker(new \Assetic\Factory\Worker\EnsureFilterWorker('/\\.sass$/', $this->get('assetic.filter.sass')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TodoBundle' => 'TodoApp\\TodoBundle\\TodoBundle',
            ...
            'locale' => 'en',
            'secret' => 'dd74acf78cc155ae26a51e766fd7beb62c381e4a',
            ...
            'kernel.secret' => 'dd74acf78cc155ae26a51e766fd7beb62c381e4a',
            ...
            'assetic.sass.bin' => '/Users/Apple/.rvm/gems/ruby-1.9.3-p547/bin/sass',
            'assetic.filter.cssrewrite.class' => 'Assetic\\Filter\\CssRewriteFilter',
            'assetic.filter.scss.class' => 'Assetic\\Filter\\Sass\\ScssFilter',
            'assetic.filter.scss.sass' => '/Users/Apple/.rvm/gems/ruby-1.9.3-p547/bin/sass',
            ...
            'assetic.filter.sass.bin' => '/Users/Apple/.rvm/gems/ruby-1.9.3-p547/bin/sass',
